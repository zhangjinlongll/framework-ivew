<template>
  <div class="inline" :class="{'fullwidth': fullwidth}">
    <ul class="ivu-cascader-menu" :class="{'fullwidth': fullwidth, 'size-normal': fontsize=='normal', 'size-large': fontsize=='large'}">
...
.ivu-cascader-menu.fullwidth {
  width: 100%;
}
.inline {
  display: inline-block;
}
.size-normal .ivu-checkbox-wrapper {
  font-size: 12px;
}
.ivu-cascader-menu-item>p{
  margin-bottom: 0;
  font-size: 14px;
}
</style>